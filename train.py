...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x, ve, cos_sin, window_size):
        ...
        # PyTorch SDPA replacing FlashAttention 3
        ...
        # Apply sliding window via mask if needed
...
class MuonAdamW(torch.optim.Optimizer):
    ...
    def __init__(self, param_groups, device_type="mps"):
        ...
        # Compile conditionally — torch.compile not supported on MPS
...
# Autocast context — MPS doesn't support bfloat16 autocast
if device_type == "cuda":
